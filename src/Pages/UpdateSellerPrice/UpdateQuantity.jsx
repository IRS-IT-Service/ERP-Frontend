...
const infoDetail = [
  ...
  },
  {
    ...
    instruction: 'Here you can See the Scanned Quantity of the product',
  },
  {
    ...
    instruction: 'Here you can see the Quantity Assigned of the product',
  },
  {
    ...
    instruction: 'Here you can see the Awaiting Scanning of the product',
  },
  {
    ...
    instruction: 'Here you can see the Quantity in Store of the product',
  },
  {
    name: 'Orange color',
    screenshot: (
  ...
  const columns = [
    {
      ...
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='Serial No.'>
    ...
    },
    {
      ...
      editable: true,
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='SKU'>
          {params.colDef.headerName}
        </span>
      ),
      renderCell: (params) => {
    ...
    },
    {
      ...
      cellClassName: 'super-app-theme--cell',
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='Product'>
          {params.colDef.headerName}
        </span>
      ),
    },
    {
      ...
      cellClassName: 'super-app-theme--cell',
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='Brand'>
          {params.colDef.headerName}
        </span>
      ),
    },
    {
      ...
      cellClassName: 'super-app-theme--cell',
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='Category'>
          {params.colDef.headerName}
        </span>
      ),
    },
    {
      ...
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='GST %'>
          {params.colDef.headerName}
        </span>
      ),
    },
    {
      ...
      valueFormatter: (params) => `${params.value}`,
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='Threshold Qty'>
          {params.colDef.headerName}
        </span>
      ),
    },
    {
      ...
      valueFormatter: (params) => `${params.value}`,
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='Sticked Quantity'>
          {params.colDef.headerName}
        </span>
      ),
    },
    {
      ...
      valueFormatter: (params) => `${params.value}`,
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='Assigned Quantity'>
          {params.colDef.headerName}
        </span>
      ),
    },
    {
      ...
      valueFormatter: (params) => `${params.value}`,
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='Awaiting Scanning'>
          {params.colDef.headerName}
        </span>
      ),
    },
    {
      ...
      type: 'number',
      renderHeader: (params) => (
        <span style={{ fontWeight: 'bold' }} title='Quantity in Store'>
          {params.colDef.headerName}
        </span>
      ),
      renderCell: (params) => {
