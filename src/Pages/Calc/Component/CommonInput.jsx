  ...
  return (
    <Box sx={{ padding: "0.5rem" }}>
      ...
      >
            ...
            <TextField
              ...
              InputProps={{
                style: {
                  ...
                  height: "25px",
                  borderRadius: "30px",
                  backgroundColor: frieghtValueCommon
                    ? "lightgray"
                    : "	 #b3d9ff",
                },
              }}
              disabled={frieghtValueCommon ? true : false}
            />
          </div>
        </Grid>
        <Grid item order={5}>
          <div>
            ...
            <TextField
              value={frieghtValueCommon}
              onChange={(e) => {
                handleValueChange("frieghtValueCommon", null, e.target.value);
              }}
              variant="outlined"
              InputProps={{
                style: {
                  ...
                  height: "25px",
                  borderRadius: "30px",
                  backgroundColor: frieghtCommon ? "lightgray" : "	 #b3d9ff",
                },
              }}
              disabled={frieghtCommon ? true : false}
            />
          </div>
        </Grid>
        ...
        <Grid item order={8}>
          <Tooltip title="Conversion Rate BOE" arrow placement="left">
            <div>
              {" "}
              <Typography
                variant="body2"
        ...
        <Grid item order={7}>
          <Tooltip title="landing for other values %" arrow placement="left">
            <div>
              {" "}
              <Typography
                variant="body2"
        ...
        <Grid item order={8}>
          <Tooltip title="GST On Shipping %" arrow placement="left">
            <div>
              <Typography
                variant="body2"
                sx={{ fontSize: "11px" }}
        ...
        <Grid item order={11}>
          <Tooltip title="regular Bill of Entry charge" arrow placement="left">
            <div>
              <Typography
                variant="body2"
                sx={{ fontSize: "11px" }}
        ...
        <Grid item order={14}>
          <Tooltip title="other Charge if any" arrow placement="left">
            <div>
              <Typography
                variant="body2"
                sx={{ fontSize: "11px" }}
