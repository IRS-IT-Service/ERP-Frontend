...
const AdminDiscountQuery = () => {
  ...
  const handleRejectQuery = async () => {
    try {
      ...
      console.log("error at discount query api ", error.Message);
    }
  };
  ...
  return (
    ...
    >
          ...
          <Table stickyHeader aria-label="sticky table">
            <TableHead>
              <TableRow>
                ...
                {/* second scenario */}
                <Styleadmin>
                  <Tooltip title="Landing Cost Without Tax">
                    <span>Cost</span>
                  </Tooltip>
                </Styleadmin>
                <Styleadmin>
                  <Tooltip title="Landing Cost With Tax">
                    <span>LCW Tax</span>
                  </Tooltip>
                </Styleadmin>
                  ...
                  (sales, index) => (
                    <TableRow key={index}>
                      ...
                      <StyleTable
                        sx={{ fontSize: ".777rem", textAlign: "center" }}
                      >
                        ₹ {(+sales.discountPrice * sales.reqQty).toFixed(2)}
                      </StyleTable>
                      <StyleTable
                        sx={{ fontSize: ".777rem", textAlign: "center" }}
                      >
                        ₹ {sales.landingCost?.toFixed(2)}
                      </StyleTable>
                      <StyleTable
                        sx={{ fontSize: ".777rem", textAlign: "center" }}
                      >
                        ...
                        {(
                          sales.landingCost +
                          (sales.GST * sales.landingCost) / 100
                        ).toFixed(2)}
                      </StyleTable>
                      <StyleTable
                        sx={{ fontSize: ".777rem", textAlign: "center" }}
      ...
      {/*  */}
      <Box
        sx={{ border: "1px solid", marginTop: ".7rem", paddingBottom: ".8rem" }}
      >
        <Typography
          variant="h6"
          textAlign="center"
          sx={{ backgroundColor: "#80bfff" }}
        >
          Price Sumarry
        </Typography>
        <Box
        ...
        >
          ...
          >
            ...
            <hr />
            <Typography>₹{query?.data?.TotalSalesPrice.toFixed(2)}</Typography>
          </Box>
          <Box
            sx={{
              fontSize: ".666rem",
          ...
          >
            ...
            <Typography>₹ {(+newTotalDiscount).toFixed(2)}</Typography>
          </Box>
          <Box
            sx={{
          ...
          >
            ...
            <Typography>
              ₹ {(+query?.data?.TotalLandingCost).toFixed(2)}
            </Typography>
          </Box>
          <Box
            sx={{
      ...
      >
        ...
        >
          ...
          <Box sx={{ ml: "15px" }}>
            <Button
              disabled={
                query?.data?.NewOfferData?.length && !query?.data?.NewOffer
                  ? true
                  : false
              }
              variant="contained"
