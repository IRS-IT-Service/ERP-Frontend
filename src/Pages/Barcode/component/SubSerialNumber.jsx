...
const infoDetail = [
  {
    name: 'Submit Sub Serial No',
    screenshot: (
      <img
        src='https://ik.imagekit.io/z7h0zeety/Admin-Portal/Info%20SS%20images/subserialSubmitBotton.png?updatedAt=1703069575156'
        height={'100%'}
        width={'100%'}
        style={
          {
    ...
    instruction: `Clicking on Submit all you submit all the products components details`,
  },
];
